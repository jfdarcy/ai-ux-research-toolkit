...
A clean, minimalist web portfolio lives at [`index.html`](./index.html). Deploy to [GitHub Pages](https://pages.github.com/) by enabling Pages from the `main` branch root.
